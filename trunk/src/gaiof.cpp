...
void on_learn_dialog_learn_button_clicked (GtkWidget * widget)
{
  ...
  GtkWidget *input_size_spinbutton;
  GtkWidget *hidden_size_spinbutton;
  GtkWidget *epsilon_initial_spinbutton;
  GtkWidget *epsilon_drop_spinbutton;
  GtkWidget *nb_iter_epsilon_spinbutton;
  GtkWidget *nb_iter_spinbutton;
  GtkTreeModel *list;
  GtkTreeIter iter;
  ...
  samples_treeview =
    glade_xml_get_widget (xml, "learn_dialog_samples_treeview");
  database_treeview = glade_xml_get_widget (xml, "database_dialog_treeview");
  class_name_entry =
    glade_xml_get_widget (xml, "learn_dialog_class_name_entry");
  save_file_dialog = glade_xml_get_widget (xml, "save_file_dialog");
  input_size_spinbutton = glade_xml_get_widget (xml, "learn_dialog_input_size_spinbutton");
  hidden_size_spinbutton = glade_xml_get_widget (xml, "learn_dialog_hidden_size_spinbutton");
  epsilon_initial_spinbutton = glade_xml_get_widget (xml, "learn_dialog_epsilon_initial_spinbutton");
  epsilon_drop_spinbutton = glade_xml_get_widget (xml, "learn_dialog_epsilon_drop_spinbutton");
  nb_iter_epsilon_spinbutton = glade_xml_get_widget (xml, "learn_dialog_nb_iter_epsilon_spinbutton");
  nb_iter_spinbutton = glade_xml_get_widget (xml, "learn_dialog_nb_iter_spinbutton");
  ...
  file_name =
    gtk_file_chooser_get_filename (GTK_FILE_CHOOSER (save_file_dialog));
  ...
  perceptron = Recognition_engine::get_engine()->get_perceptron(class_name);
  
  perceptron->set_input_size((int) gtk_spin_button_get_value(GTK_SPIN_BUTTON (input_size_spinbutton)));
  perceptron->set_hidden_size((int) gtk_spin_button_get_value(GTK_SPIN_BUTTON (hidden_size_spinbutton)));
  perceptron->set_epsilon_initial(gtk_spin_button_get_value(GTK_SPIN_BUTTON (epsilon_initial_spinbutton)));
  perceptron->set_epsilon_drop(gtk_spin_button_get_value(GTK_SPIN_BUTTON (epsilon_drop_spinbutton)));
  perceptron->set_nb_iter_epsilon((int) gtk_spin_button_get_value(GTK_SPIN_BUTTON (nb_iter_epsilon_spinbutton)));
  perceptron->set_nb_iter((int) gtk_spin_button_get_value(GTK_SPIN_BUTTON (nb_iter_spinbutton)));
  
  perceptron->init();
  perceptron->learn (samples);
  perceptron->save (file_name);

  list = gtk_tree_view_get_model (GTK_TREE_VIEW (database_treeview));
  gtk_list_store_append (GTK_LIST_STORE (list), &iter);
  gtk_list_store_set (GTK_LIST_STORE (list), &iter, 0, class_name.c_str (),
                      -1);
...
void on_recognize_dialog_recognize_button_clicked (GtkWidget * widget)
{
  ...
  while ((column = gtk_tree_view_get_column(GTK_TREE_VIEW (treeview), 0)) != 0)
    gtk_tree_view_remove_column(GTK_TREE_VIEW (treeview), column);

  column =
    gtk_tree_view_column_new_with_attributes ("Processed files",
  ...
  {
    column =
      gtk_tree_view_column_new_with_attributes (it->c_str (),
                                                gtk_cell_renderer_text_new (),
                                                "text", i, NULL);
    gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);
  }
...
int gaiof_main (int argc, char **argv)
{
  ...
  glade_xml_signal_connect (xml, "on_main_learn_button_clicked",
                            G_CALLBACK (on_main_learn_button_clicked));
  glade_xml_signal_connect (xml, "on_learn_dialog_samples_add_button_clicked",
                            G_CALLBACK
                            (on_learn_dialog_samples_add_button_clicked));
  glade_xml_signal_connect (xml,
                            "on_learn_dialog_samples_remove_button_clicked",
                            G_CALLBACK
                            (on_learn_dialog_samples_remove_button_clicked));
  glade_xml_signal_connect (xml, "on_learn_dialog_learn_button_clicked",
                            G_CALLBACK
                            (on_learn_dialog_learn_button_clicked));
  glade_xml_signal_connect (xml, "on_learn_dialog_save_button_clicked",
                            G_CALLBACK (on_learn_dialog_save_button_clicked));

  glade_xml_signal_connect (xml, "on_main_open_button_clicked",
                            G_CALLBACK (on_main_open_button_clicked));

  glade_xml_signal_connect (xml, "on_main_recognize_button_clicked",
                            G_CALLBACK (on_main_recognize_button_clicked));
  glade_xml_signal_connect (xml, "on_recognize_dialog_add_button_clicked",
                            G_CALLBACK
                            (on_recognize_dialog_add_button_clicked));
  glade_xml_signal_connect (xml, "on_recognize_dialog_remove_button_clicked",
                            G_CALLBACK
                            (on_recognize_dialog_remove_button_clicked));
  glade_xml_signal_connect (xml,
                            "on_recognize_dialog_recognize_button_clicked",
                            G_CALLBACK
                            (on_recognize_dialog_recognize_button_clicked));

  glade_xml_signal_connect (xml, "gtk_main_quit", G_CALLBACK (gtk_main_quit));
  glade_xml_signal_connect (xml, "gtk_widget_hide",
                            G_CALLBACK (gtk_widget_hide));
  glade_xml_signal_connect (xml, "gtk_widget_show",
  ...
  column =
    gtk_tree_view_column_new_with_attributes ("Files to learn",
                                              gtk_cell_renderer_text_new (),
                                              "text", 0, NULL);
  gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);
  ...
  column =
    gtk_tree_view_column_new_with_attributes ("Classes learned",
                                              gtk_cell_renderer_text_new (),
                                              "text", 0, NULL);
  gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);
  ...
  column =
    gtk_tree_view_column_new_with_attributes ("Files to process",
                                              gtk_cell_renderer_text_new (),
                                              "text", 0, NULL);
  gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);
...
void progress_bar_set_local_value (float value)
{
  ...
  progress_bar =
    glade_xml_get_widget (xml, "progress_dialog_local_progressbar");
...
void progress_bar_set_total_value (float value)
{
  ...
  progress_bar =
    glade_xml_get_widget (xml, "progress_dialog_total_progressbar");
